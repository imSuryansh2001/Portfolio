    ...
    return (
        <>
            ...
            <div className='w-[95%] md:flex-row md:justify-evenly md:items-center flex flex-col m-auto mt-8'>
                <div className='w-[90%] lg:w-[20%] md:h-[20vh] md:flex md:items-center md:mt-20 md:w-[30%] border-2 rounded-2xl border-[#e1b7d8] m-auto mt-6' data-aos="zoom-in">
                    <p className='text-[#E1B7D8] text-lg p-4 md:text-center '>Working in ACM student chapter Chitkara (Web team)</p>
                </div>

                <div className='w-[90%] lg:w-[20%] md:h-[20vh] md:flex md:items-center md:w-[30%] border-2 rounded-2xl border-[#e1b7d8] m-auto mt-6' data-aos="zoom-in-up">
                    <p className='text-[#E1B7D8] text-lg p-4 md:text-center '>Solo learning is the fastest way to learn something new</p>
                </div>

                <div className='w-[90%] lg:w-[20%] md:h-[20vh] md:flex md:items-center md:mt-20 md:w-[30%] border-2 rounded-2xl border-[#e1b7d8] m-auto mt-6' data-aos="zoom-in-down">
